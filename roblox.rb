-- game: https://www.roblox.com/games/3964975083/Build-to-survive
-- IMPORTANT! make sure the game is by Feather Fall Productions Or It will Not Work.
 
local ToggleGuis = true
 
local BuildToSurviveGUI = Instance.new("ScreenGui")
...
BuildToSurviveGUI.Name = "Build To Survive GUI"
BuildToSurviveGUI.Parent = game.CoreGui
BuildToSurviveGUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    ...
    function()
        for GetBases, _1 in pairs(workspace:FindFirstChild("Bases"):GetChildren()) do
            if _1:IsA("Model") then
                for BaseStorages, _2 in pairs(_1:FindFirstChild("Blocks"):GetChildren()) do
...
RemoveMobs.MouseButton1Click:Connect(
    function()
        for i, v in pairs(workspace.Mobs:GetChildren()) do
            if v:IsA("Model") then
                game.ReplicatedStorage.PlayerEvents["e" .. game.Players.LocalPlayer.UserId].DestroyItem:FireServer(v)
            end
        end
    end
)
...
Normal.MouseButton1Click:Connect(
    function()
        for _, Shutdown in pairs(game.Players:GetPlayers()) do
            game.ReplicatedStorage.PlayerEvents["e" .. game.Players.LocalPlayer.UserId].DestroyItem:FireServer(Shutdown)
        end
    end
)
...
Full.MouseButton1Click:Connect(
    function()
        for _, Shutdown in pairs(game:GetDescendants()) do
            ...
            Bypass4 = Shutdown
            if
                Bypass1.Name ~= "PlayerEvents" and Bypass2.Name ~= "e" .. game.Players.LocalPlayer.UserId and
            ...
            if game.Players:FindFirstChild(v) then
                if game.Players:FindFirstChild(v).Character then
                    if game.Players[v].Character:FindFirstChild("Torso") then
                        if game.Players[v].Character.Torso:FindFirstChild("Neck") then
                            game.ReplicatedStorage.PlayerEvents["e" .. game.Players.LocalPlayer.UserId].DestroyItem:FireServer(
                                game.Players[v].Character.Torso.Neck
                            )
                        end
                    elseif game.Players[v].Character:FindFirstChild("UpperTorso") then
                        game.ReplicatedStorage.PlayerEvents["e" .. game.Players.LocalPlayer.UserId].DestroyItem:FireServer(
...
Ragdoll.MouseButton1Click:Connect(
    function()
        for i, v in pairs(GetPlayer(Victim.Text)) do
            if game.Players:FindFirstChild(v) then
                if game.Players:FindFirstChild(v).Character then
                    if game.Players:FindFirstChild(v).Character:FindFirstChild("Humanoid") then
                        game.ReplicatedStorage.PlayerEvents["e" .. game.Players.LocalPlayer.UserId].DestroyItem:FireServer(
...
TeleportTo.MouseButton1Click:Connect(
    function()
        for i, v in pairs(GetPlayer(Victim.Text)) do
            if game.Players:FindFirstChild(v) then
                if
                    game.Players[v].Character:FindFirstChild("HumanoidRootPart") and
            ...
            function()
                game.ReplicatedStorage.PlayerEvents["e" .. game.Players.LocalPlayer.UserId].PlaceItem:FireServer(
                    game.Players.LocalPlayer:GetMouse().Target.CFrame +
                        Vector3.new(0, game.Players.LocalPlayer:GetMouse().Target.Size.Y, 0),
